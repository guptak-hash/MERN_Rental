...
const Cars = () => {
    ...
    const pickupLocation = searcParams.get('pickupLocation')
    const pickupDate = searcParams.get('pickupDate')
    const returnDate = searcParams.get('returnDate')
...
available for your next adventure'/>
            ...
            rounded-full shadow'>
                    ...
                    <input onChange={(e) => setInput(e.target.value)} value={input} type='text'
                        placeholder='Search by make, model, or features' className='w-full h-full outline-none
                text-gray-500'/>
